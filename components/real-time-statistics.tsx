    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <Card className="bg-slate-900 border-slate-700 p-6 shadow-sm hover:shadow-md transition-shadow">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-slate-300 text-sm font-medium">Total Attendees</p>
      ...
      {/* Seats Filled */}
      <Card className="bg-slate-900 border-emerald-700 p-6 shadow-sm hover:shadow-md transition-shadow">
        <div className="flex items-center justify-between">
          <div>
            <p className="text-slate-300 text-sm font-medium">Seats Filled</p>
            <p className="text-3xl font-bold text-white mt-2">
              {stats.seatsFilled}
            </p>
            <p className="text-slate-500 text-xs mt-1">Assigned seats</p>
          </div>
          <Armchair className="w-12 h-12 text-emerald-400/30" />
        </div>
      </Card>
